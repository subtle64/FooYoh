...
import { View, Text, Heading, ScrollView, Divider, Button, ButtonText, HStack, ModalBackdrop, ModalHeader, ModalBody, CloseIcon, useToast, Toast } from '@gluestack-ui/themed';
    ...
    function AlreadyPurchasedButtons() {
        return(
            <View width={"100%"} position={"absolute"} flexDirection='row' gap={12} bottom={0} justifyContent='center' alignItems='center' marginBottom={18}>
                <Button size="sm" borderRadius={32} bgColor='#FF6700'>
